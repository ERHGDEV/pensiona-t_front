      ...
      <footer className="bg-sky-900 py-8 text-center text-sky-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-4 flex justify-center space-x-6">
            ...
            <a href="https://www.instagram.com/pensiona_t" target='_blank' className="text-sky-200 hover:text-white">
...
{/*         <a href="#" target='_blank' className="text-sky-200 hover:text-white">
